...
// TextMessages removed — parent-teacher chat is private; students don't participate
...
const MainContent = () => {
  ...
  const isTeacherDashboardRoute = location.pathname.startsWith('/teacher-dashboard') ||
                                  ...
                                  location.pathname.startsWith('/teacher-text-messages') ||
                                  location.pathname.startsWith('/teacher-create-assignments') ||
                                  location.pathname.startsWith('/teacher-assignment-reviews') ||
                                  location.pathname.startsWith('/teacher-office-hours') ||
                                  location.pathname.startsWith('/teacher-community');
  ...
  const isParentRoute = location.pathname.startsWith('/parent-login') || location.pathname.startsWith('/parent-messages') || location.pathname.startsWith('/parent-dashboard');
  ...
  return (
    <>
      ...
      <Routes>
          ...
          <Route path='/my-groups' element={<StudentGroups />}/>
          ...
          <Route path='/teacher-text-messages' element={<TeacherLayout />}>
            <Route index element={<TeacherMessages />}/>
          </Route>
          <Route path='/teacher-create-assignments' element={<TeacherLayout />}>
            <Route index element={<TeacherAssignmentCreate />}/>
          </Route>
          <Route path='/teacher-office-hours' element={<TeacherLayout />}>
            <Route index element={<TeacherOfficeHours />}/>
          </Route>
          <Route path='/teacher-community' element={<TeacherLayout />}>
            <Route index element={<TeacherCommunity />}/>
          </Route>
      ...
      {!isAdminRoute && !isSchoolRoute && !isSchoolDashboardRoute && !isParentConsentRoute && !isParentRoute && !(isTeacherDashboardRoute && teacherLoginStatus === 'true') && <Footer />}
    </>
  )
}
