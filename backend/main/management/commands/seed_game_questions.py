...
class Command(BaseCommand):
    ...
    def _seed_rhythm_rush(self):
        ...
        questions = [
            # LEVEL 1 – Beginner pacing (55 BPM) with generous timing window.
            {'level': 1, 'prompt': 'Tap 4 quarter notes at 60 BPM',
             'question_payload': {'bpm': 55, 'time_signature': '4/4', 'note_types': ['quarter', 'quarter', 'quarter', 'quarter'],
                                  'expected_timestamps': [0, 1091, 2182, 3273], 'tolerance_ms': 260,
                                  'description': 'Four steady quarter notes at beginner tempo'},
             'choices': [], 'correct_answer': '', 'time_limit_seconds': 10, 'points': 10},
            {'level': 1, 'prompt': 'Tap 3 quarter notes at 60 BPM',
             'question_payload': {'bpm': 55, 'time_signature': '3/4', 'note_types': ['quarter', 'quarter', 'quarter'],
                                  'expected_timestamps': [0, 1091, 2182], 'tolerance_ms': 260,
            ...
            # LEVEL 2 – Quarter notes at 65 BPM (923ms)
            {'level': 2, 'prompt': 'Tap 4 quarter notes at 80 BPM',
             'question_payload': {'bpm': 65, 'time_signature': '4/4', 'note_types': ['quarter', 'quarter', 'quarter', 'quarter'],
                                  'expected_timestamps': [0, 923, 1846, 2769], 'tolerance_ms': 240,
            ...
            {'level': 2, 'prompt': 'Tap 4 quarter notes at a moderately fast tempo',
             'question_payload': {'bpm': 65, 'time_signature': '4/4', 'note_types': ['quarter', 'quarter', 'quarter', 'quarter'],
                                  'expected_timestamps': [0, 923, 1846, 2769], 'tolerance_ms': 240,
                                  'description': 'Steady beat at 65 BPM'},
             'choices': [], 'correct_answer': '', 'time_limit_seconds': 8, 'points': 12},
            {'level': 2, 'prompt': 'Tap 3 quarter notes at 80 BPM',
             'question_payload': {'bpm': 65, 'time_signature': '3/4', 'note_types': ['quarter', 'quarter', 'quarter'],
                                  'expected_timestamps': [0, 923, 1846], 'tolerance_ms': 240,
                                  'description': 'Three beats at 65 BPM'},
             'choices': [], 'correct_answer': '', 'time_limit_seconds': 6, 'points': 12},

            # LEVEL 3 – Quarter + eighth note combos at 72 BPM
            {'level': 3, 'prompt': 'Tap: quarter, two eighths, quarter',
             'question_payload': {'bpm': 72, 'time_signature': '4/4', 'note_types': ['quarter', 'eighth', 'eighth', 'quarter'],
                                  'expected_timestamps': [0, 833, 1249, 1666], 'tolerance_ms': 220,
            ...
            {'level': 3, 'prompt': 'Tap: two eighths, quarter, quarter',
             'question_payload': {'bpm': 72, 'time_signature': '4/4', 'note_types': ['eighth', 'eighth', 'quarter', 'quarter'],
                                  'expected_timestamps': [0, 416, 833, 1666], 'tolerance_ms': 220,
                                  'description': 'Two eighth notes then two quarter notes'},
             'choices': [], 'correct_answer': '', 'time_limit_seconds': 8, 'points': 14},
            {'level': 3, 'prompt': 'Tap: quarter, quarter, two eighths',
             'question_payload': {'bpm': 72, 'time_signature': '4/4', 'note_types': ['quarter', 'quarter', 'eighth', 'eighth'],
                                  'expected_timestamps': [0, 833, 1666, 2082], 'tolerance_ms': 220,
